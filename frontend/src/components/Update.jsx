...
const Update = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await axios.put(`https://employee-system-render-backend.onrender.com/update/${id}`, input);
   ...
   const getRecord = async () => {
      try {
        const res = await axios.get(`https://employee-system-render-backend.onrender.com/findbyid/${id}`);
        setInput({
          name: res.data.name,
          age: res.data.age,
