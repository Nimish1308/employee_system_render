...
const Record = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const res = await axios.post(`https://employee-system-render-backend.onrender.com/create`, input);
    ...
    const getRecord = async () => {
        try {
            const res = await axios.get(`https://employee-system-render-backend.onrender.com/find`);
    ...
    const handleDelete = async (id) => {
        try {
            const res = await axios.delete(`https://employee-system-render-backend.onrender.com/delete/${id}`);
